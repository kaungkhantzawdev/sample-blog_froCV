            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <?php
                        $id = $_GET['id'];
                        $currentPhoto = adsOne($id);
                        if(isset($_POST['adsBtn'])){
                            if(adsUpdate()){
                               return linkTo('ads_add.php');
                            };
                        }
                        ?>
                        <form action="" method="post"   enctype="multipart/form-data" >
                            <div class="">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    <input type="text" class="form-control w-50 me-2" value="<?php echo $currentPhoto['ads_name']; ?>" name="title" required autofocus>
                                    <input type="file" accept="image/gif, image/png, image/jpg" class="form-control w-50 " name="upload" required >
                                </div>
                                <input type="text" class="form-control w-100 mb-2" value="<?php echo $currentPhoto['link']; ?>" name="link" required >
                                <div class="d-flex align-items-center mb-2">
                                    <input type="date" class="form-control w-25 me-2" value="<?php echo $currentPhoto['start']; ?>" name="start" required >
                                    <input type="date" class="form-control w-25 me-2 " value="<?php echo $currentPhoto['final']; ?>" name="end" required >
